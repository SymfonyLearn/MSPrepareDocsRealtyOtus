...
use App\Entity\ValueObject\BuyerId;
...
class BuyerIdTest extends TestCase
{
    ...
    public function ValueGetsCreatedWithEmptyValue($value): void
    {
        ...
        $this->expectExceptionMessage(BuyerId::MESSAGE_IS_NOT_POSITIVE_NUMBER);
    ...
    {
        $value1 = new BuyerId(1234567890);
        $value2 = new BuyerId(1234567890);
